...
help:
	...
	@echo ""
	@echo "$(CYAN)【服务管理】$(NC)"
	@echo "  $(YELLOW)make start$(NC)        - 🚀 启动 FastAPI"
	@echo "  $(YELLOW)make stop$(NC)         - 🛑 停止 FastAPI"
	@echo "  $(YELLOW)make restart$(NC)      - 🔄 重启 FastAPI"
	...
	@echo "  2. 启动服务:   $(YELLOW)make start$(NC)"
	@echo "  3. 检查状态:   $(YELLOW)make check$(NC)"
...
# 启动 FastAPI（与 start-api 等价，便于沿用 make start 习惯）
start:
	@$(MAKE) start-api
